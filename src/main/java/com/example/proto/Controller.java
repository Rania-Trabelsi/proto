...
// Ajoutez d'autres enseignants ici
    ...
    private void generateTimeSlots() {
        ...
        for (LocalTime time = LocalTime.of(8, 30); !time.isAfter(LocalTime.of(19, 0)); time = time.plusMinutes(30)) {
            ...
            timeLabel.setStyle("-fx-background-color: #78909C; -fx-text-fill: white; -fx-padding: 5; -fx-alignment: center;");
    ...
    private void generateWeekDays(int actualWeek) {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            dayLabel.setStyle("-fx-background-color: #5DAA9B; -fx-text-fill: white; -fx-padding: 5; -fx-alignment: center;");
